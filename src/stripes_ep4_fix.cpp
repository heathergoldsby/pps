...
, generational_models::periodic_competition < generational_models::meta_moran_process< selection::tournament< >, selection::random< > >, generational_models::isolated_subpopulations > // generational_models::moran_process< >, isolated_subpopulations
