...
#include "stripes.h"
#include "movie.h"
#include "three_stripe_ancestor.h"
...
public:
    virtual void gather_options() {
        ...
        add_option<PROPAGULE_IDENTICAL>(this);
        add_option<PROPAGULE_COPY>(this);
...
//        add_event<datafiles::propagule_size_dat>(ea);
        add_event<datafiles::propagule_epi_dat>(ea);
