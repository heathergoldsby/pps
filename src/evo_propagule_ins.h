...
DIGEVO_INSTRUCTION_DECL(prop_size_1) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 1;
}
DIGEVO_INSTRUCTION_DECL(prop_size_2) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 2;
}
DIGEVO_INSTRUCTION_DECL(prop_size_3) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 3;
}
DIGEVO_INSTRUCTION_DECL(prop_size_4) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 4;
}
DIGEVO_INSTRUCTION_DECL(prop_size_5) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 5;
}
DIGEVO_INSTRUCTION_DECL(prop_size_6) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 6;
}
DIGEVO_INSTRUCTION_DECL(prop_size_7) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 7;
}
DIGEVO_INSTRUCTION_DECL(prop_size_8) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 8;
}
DIGEVO_INSTRUCTION_DECL(prop_size_9) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 9;
}
DIGEVO_INSTRUCTION_DECL(prop_size_10) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 10;
}
DIGEVO_INSTRUCTION_DECL(prop_size_11) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 11;
}
DIGEVO_INSTRUCTION_DECL(prop_size_12) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 12;
}
DIGEVO_INSTRUCTION_DECL(prop_size_13) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 13;
}
DIGEVO_INSTRUCTION_DECL(prop_size_14) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 14;
}
DIGEVO_INSTRUCTION_DECL(prop_size_15) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 15;
}
DIGEVO_INSTRUCTION_DECL(prop_size_16) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 16;
}
DIGEVO_INSTRUCTION_DECL(prop_size_17) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 17;
}
DIGEVO_INSTRUCTION_DECL(prop_size_18) {
    get<PROPAGULE_SIZE>(*p,get<START_PROPAGULE_SIZE>(*p,18)) = 18;
}
