...
namespace ealib {
    namespace datafiles {
        ...
        struct fitness_variance_dat : record_statistics_event<EA> {
            fitness_variance_dat(EA& ea) : record_statistics_event<EA>(ea), _df("fitness_variance.dat") {
                _df.add_field("update")
                .add_field("mean_generation")
                .add_field("min_fitness")
                .add_field("mean_fitness")
                .add_field("max_fitness")
                .add_field("fitness_variance");
            }
            
            virtual ~fitness_variance_dat() {
            }
